    ...
    <nav class="navbar navbar-expand-lg navbar-light">
      <div class="container">
        ...
        <div class="navbar-collapse collapse" id="navbarContent">
		 ...
		 <li class="nav-item">
              <a href="equipment_details.html" class="nav-link">Add Equipment</a>
            </li>
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="equipmentDropdown">
                <a href="issuedetails.html" class="dropdown-item">Issue Details</a>
    ...
    <div class="page-section">
      <div class="container">
        <div class="text-center">
          <h2 class="title-section mb-3">Issue Details</h2>
          <%

String reqeustid=request.getParameter("id");
String farmerid=request.getParameter("fname");

String eqowner=session.getAttribute("uname").toString();
...
%>
        ...
        <div class="row justify-content-center mt-5">
          <div class="col-lg-8">
            <form action="insertissue.jsp" method="post" class="form-contact">
              <div class="row">
                <!-- <div class="col-12 py-2">
                  <label for="name" class="fg-grey">Issue Id</label>
                  <input type="text" class="form-control" id="issueid" name="t1" placeholder="Enter Issue Id">
                </div> -->
                
                <div class="col-12 py-2">
                  <label for="subject" class="fg-grey">Request Id</label>
                  <input type="text" class="form-control" value=<%=reqeustid %>  id="requestid" name="t2" >
                </div>
 <div class="col-12 py-2">
                  <label for="subject" class="fg-grey">Farmer Id</label>
                  <input type="text" class="form-control" value=<%=farmerid %> id="farmerid" name="t3" >
                </div>

<div class="col-12 py-2">
                  <label for="subject" class="fg-grey">Equipment Farmer Id</label>
                  <input type="text" class="form-control" value=<%=eqowner %> id="equipmentowner" name="t4" >
                </div>

 <div class="col-12 py-2">
                  <label for="subject" class="fg-grey">Issue Date</label>
                  <input type="Date" class="form-control" id="issuedate" name="t5" >
                </div>

 <div class="col-12 py-2">
                  <label for="subject" class="fg-grey">Time</label>
                  <input type="Time" class="form-control" id="time" name="t6" >
                </div>

 <div class="col-12 py-2">
                  <label for="subject" class="fg-grey">Condition</label>
                  <input type="text" class="form-control" id="condition" name="t7" >
                </div>
