    ...
    <div class="page-section">
      <div class="container">
        <div class="text-center">
          <h2 class="title-section mb-3">Rent Equipments</h2>
        </div>
          ...
          <div class="col-lg-8">
            <form action="#" method="post" class="form-contact">
              <center>
                <table border="2">
                  <tr>
                    <td width="70" height="30"><center>Equipment Id</center></td>
                    <td width="70" height="30">Name</td>
                    <td width="100" height="30">Farmer Id</td>
                    <td width="70" height="30">Address</td>
                    <td width="70" height="30">Details</td>
                    <td width="70" height="30">Cost Per Day</td>
                   <td width="70" height="30">Image</td>
                    <td width="90" height="30">Rent</td>
                  </tr>

                  <%@ include file="dbcon.jsp" %>
                  <%
                    ResultSet rs = stmt.executeQuery("select * from equipment_details");
                    while (rs.next()) {
                  %>
                      <tr>
                        ...
                        <td><center><img src="./upload/<%= rs.getString(7) %>" width=150 height=150 /></center></td>
                        <td>
                          <a href="request_details.jsp?id=<%= rs.getString(1) %>&fname=<%=rs.getString(3) %>" ><center> 
                            Rent</center>
                          </a>
                        </td>
                      </tr>
