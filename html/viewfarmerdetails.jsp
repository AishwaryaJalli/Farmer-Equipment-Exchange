    ...
    <div class="page-section">
      <div class="container">
        <div class="text-center">
          <h2 class="title-section mb-3">View Farmer Details</h2>
          
        </div>
        <div class="row justify-content-center mt-5">
          <div class="col-lg-8">
            <form action="insertfarmer.jsp" method="post" class="form-contact">
              <center>
 		...
 		<td> Delete </td>
                ...
                <%
                  ResultSet rs=stmt.executeQuery("select * from farmer_details");
                  while(rs.next())
                  {
                %>
                    ...
                    <tr>
                     ...
                     <!-- <td>
                      <a href="delfarmer.jsp?id=<%=rs.getString(1) %>"
                      onclick="return confirm('Do you want to delete this equipment details?');"> 
                      Delete 
                      </a> 
                      </td> -->
                      <td><a href="delfarmer.jsp?id=<%=rs.getString(1) %>"> Delete </a> </td>
                    </tr>
                  <%
                    }
                  %>
