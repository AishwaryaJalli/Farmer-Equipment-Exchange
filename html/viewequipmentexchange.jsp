    ...
    <div class="page-section">
      <div class="container">
        <div class="text-center">
          <h2 class="title-section mb-3">View Equipment Exchange Details</h2>
		...
		<table border=2>
 		<tr>
                ...
                <%
                  ResultSet rs=stmt.executeQuery("select * from equipment_exchange");
                  while(rs.next())
                  {
                %>
                    ...
                    <tr>
                     ...
                     <td><a href="delexchange.jsp?id=<%=rs.getString(1) %>"> Delete </a> </td>
                      </tr>
                <%
                  }
                %>
