    ...
    <div class="page-section">
      <div class="container">
        <div class="text-center">
          <h2 class="title-section mb-3">View Request Details</h2>
              ...
              <center>
                ...
                <%
                 String user=session.getAttribute("uname").toString();
                  ResultSet rs=stmt.executeQuery("select * from request_details where farmer_name='"+user+"' ");
                  while(rs.next())
                  {
                %>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="issuedetails.jsp?id=<%= rs.getString(1) %>&fname=<%=rs.getString(3) %>" ><center> 
                          Issue</center>
                        </a>
                      </td>
                     <td><a href="delrequestdetails.jsp?id=<%=rs.getString(1) %>"> Delete </a> </td>
                      </tr>
                <%
                  }
                %>
