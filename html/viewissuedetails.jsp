    ...
    <div class="page-section">
      <div class="container">
        <div class="text-center">
          <h2 class="title-section mb-3">View Issue Details</h2>
        ...
        <div class="row justify-content-center mt-5">
 		...
 		<td> Delete </td>
                ...
                <%
                  ResultSet rs=stmt.executeQuery("select * from issue_details");
                  while(rs.next())
                  {
                %>
		      ...
		      <td> <%=rs.getString(7) %></td>
                     ...
                     <td><a href="delissuedetails.jsp?id=<%=rs.getString(1) %>"> Delete </a> </td>
                      </tr>
                <%
                  }
                %>
