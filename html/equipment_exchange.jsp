    ...
    <div class="page-section">
      <div class="container">
        <div class="text-center">
          <h2 class="title-section mb-3">Equipment Exchange</h2>
          
        </div>
        <div class="row justify-content-center mt-5">
          <div class="col-lg-8">
            <form action="insertexchange.jsp" method="post" class="form-contact">
              <div class="row">
                <div class="col-12 py-2">
                  <label for="name" class="fg-grey">Equipment Id</label> 
                  <input type="text" class="form-control" id="equipmentid" name="t1" value=<%=eid %>>
                </div>
                
                <div class="col-12 py-2">
                  <label for="subject" class="fg-grey">Equipment owner Name</label> 
                  <input type="text" class="form-control" id="name" name="t2" value=<%=ofname %> >
                </div>
 <div class="col-12 py-2">
                  <label for="subject" class="fg-grey">Request Farmer  Name </label> 
                  <input type="text" class="form-control" id="farmerid" name="t3" value=<%=fname %>>
                </div>
...
<div class="col-12 py-2">
 ...
 <div class="col-12 py-2">
                  ...
                  <input type="text" class="form-control" id="costperday" name="t6" value="Exchange" readonly>
                </div>
