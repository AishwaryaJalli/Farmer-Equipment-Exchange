    ...
    <div class="page-section">
      <div class="container">
        <div class="text-center">
          <h2 class="title-section mb-3">Rent Equipment</h2>
        </div>
                ...
                <table border="2">
                  ...
                  %>
                      <tr>
                        ...
                        <td><img src="./upload/<%= rs.getString(7) %>" width=150 height=150 /></td>
                        <td>
                          <a href="equipment_exchange.jsp?id=<%= rs.getString(1) %>&fname=<%=rs.getString(3) %>" > 
                            Exchange
                          </a>
                        </td>
                      </tr>
